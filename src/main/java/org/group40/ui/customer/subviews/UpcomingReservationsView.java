...
public class UpcomingReservationsView extends BaseView {
    private static final Color BG = new Color(200, 245, 220);
    private final DefaultTableModel model = new DefaultTableModel();
    private JTable table;

    public UpcomingReservationsView(AppContext ctx) {
        super(ctx, BG);

        this.add(topBar("My Upcoming Reservations", "Back",
    ...
    private void loadUpcomingReservations() {
        try {
            ...
            List<Map<String, Object>> list = ctx.reservationDAO.getUpcomingReservations(userID);
            ...
            if (list.isEmpty()) {
                JOptionPane.showMessageDialog(this, "You have no upcoming reservations.");
            }
